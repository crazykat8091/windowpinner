...
> This guide covers everything from first launch to advanced Focus Lock usage, including the new Enhanced mode introduced in V0.8.
...
- **Window Pinner** title with version number (V0.8)
...
This is the V0.8 fix scenario. If Enhanced Mode is shown but the game still pauses:
